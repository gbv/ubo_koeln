...
public class KoelnPIDSearch extends MCRServlet implements IdentityPickerService {

    private final static Logger LOGGER = LogManager.getLogger(KoelnPIDSearch.class);
    ...
    private void doSearch(HttpServletRequest req, HttpServletResponse res, String session)
        ...
        Element koelnpidsearch = new Element("koelnpidsearch");
    ...
    private void setReferrer(HttpServletRequest req, Element koelnpidsearch) {
        String referrer = req.getParameter("_referrer");
        if (referrer == null)
            referrer = req.getHeader("referer"); // Yes, with the legendary misspelling.
        koelnpidsearch.setAttribute("referrer", referrer);
    }
    ...
    private void performSearch(Element koelnpidsearch, Map<String, String> parameters) {
    ...
    private void setParametersToElement(Element koelnpidsearch, Map<String, String> parameters) {
        handleParameter(parameters, "term", koelnpidsearch);
        handleParameter(parameters, "pid", koelnpidsearch);
    }
