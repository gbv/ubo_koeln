...
>
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <xsl:apply-templates select="koelnpidsearch" />
            </body>
        </html>
    </xsl:template>
    ...
    <xsl:template match="koelnpidsearch">
    ...
    <xsl:template match="person">
        <tr>
            ...
            <td>
                <ul>
                    <xsl:if test="academicDegree">
                        <li><xsl:value-of select="academicDegree" /></li>
                    </xsl:if>
                    <xsl:if test="faculty">
                        <li><xsl:value-of select="faculty" /></li>
                    </xsl:if>
                    <xsl:if test="institute">
                        <li><xsl:value-of select="institute" /></li>
                    </xsl:if>
                    <xsl:if test="institution">
                        <li><xsl:value-of select="institution" /></li>
                    </xsl:if>
                </ul>
            </td>
        </tr>
