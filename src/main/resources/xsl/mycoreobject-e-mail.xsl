...
<xsl:template name="build.subject">
  <subject>
    <xsl:text>Digitale Hochschulbibliografie der TH Köln: </xsl:text>
...
der folgende Eintrag ist per Selbsteingabe an die Digitale Hochschulbibliografie der TH Köln gemeldet worden:
...
Ihre Digitale Hochschulbibliografie der TH Köln
</xsl:text>
  </body>
</xsl:template>
