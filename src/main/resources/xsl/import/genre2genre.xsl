...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="mods:mods/mods:genre">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$genre='bachelor thesis'">book</xsl:when>
      ...
      <xsl:when test="$genre='doctoral thesis'">dissertation</xsl:when>
      <xsl:when test="$genre='working paper'">report</xsl:when>
      ...
      <xsl:when test="$genre='contribution to periodical'">article</xsl:when>
      ...
      <xsl:when test="$genre='study thesis'">report</xsl:when>
      ...
      <xsl:when test="$genre='master thesis'">book</xsl:when>
      ...
      <xsl:when test="$genre='preprint'">article</xsl:when>
      <xsl:when test="$genre='software'">software</xsl:when>
      <xsl:when test="$genre='periodical'">collection</xsl:when>
  ...
  <xsl:template match="mods:relatedItem[@type='host']/mods:genre">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$child_genre='book part'">chapter</xsl:when>
